...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~cda3c1d64572bcb324e26473ec929652:58452b42656639634f50413d',
    ...
    SUDO: process.env.SUDO || "💫Disindu Damsandu💫",
